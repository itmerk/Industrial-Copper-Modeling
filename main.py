...
st.write("""<div style='text-align:center'> <h1 style='color:#008877;'>Industrial Copper Modeling Application</h1> </div>""", unsafe_allow_html=True)
...
with tab1:
    ...
    if submit_button and flag == 0:
        ...
        with open(r"D:\Data Science\Projects\My Projects\Project 5\model.pkl", 'rb') as file:
            load_model = pickle.load(file)
        with open(r"D:\Data Science\Projects\My Projects\Project 5\scaler.pkl", 'rb') as file:
            load_scaler = pickle.load(file)
        with open(r"D:\Data Science\Projects\My Projects\Project 5\scaler_OHE.pkl", 'rb') as file:
            load_OHE = pickle.load(file)
        with open(r"D:\Data Science\Projects\My Projects\Project 5\scaler_OHE2.pkl", 'rb') as file:
            load_OHE2 = pickle.load(file)
        ...
        new_sample_ohe = load_OHE.transform(new_sample[:, [7]]).toarray()
        new_sample_be = load_OHE2.transform(new_sample[:, [8]]).toarray()
        new_sample = np.concatenate((new_sample[:, [0, 1, 2, 3, 4, 5, 6, ]], new_sample_ohe, new_sample_be), axis=1)
        new_sample1 = load_scaler.transform(new_sample)
...
with tab2:
    ...
    if csubmit_button and cflag == 0:
        ...
        with open(r"D:\Data Science\Projects\My Projects\Project 5\clsmodel.pkl", 'rb') as file:
            cloaded_model = pickle.load(file)

        with open(r"D:\Data Science\Projects\My Projects\Project 5\cscaler.pkl", 'rb') as f:
            cscaler_loaded = pickle.load(f)

        with open(r"D:\Data Science\Projects\My Projects\Project 5\ct.pkl", 'rb') as f:
...
st.write(f'<h6 style="color:rgb(0, 153, 153,0.35);">App Created by Ramkumar.K</h6>', unsafe_allow_html=True)
